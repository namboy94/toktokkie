...
class IdHelper:
    ...
    def objectify_ids(ids: Dict[str, List[str]]) -> Dict[IdType, List[str]]:
        """
        Converts the keys in an ID dictionary using string keys to IdType
        objects
        :param ids: The ID dictionary to convert
        :return: The converted ID dictionary
            """
    ...
    def fill_ids(
        ...
        :param _parent_ids: Optionally provided dictionary of parent IDs.
                            The values of this dictionary will be entered into
                            the filled dictionary if they aren't defined
                            already.
    ...
    @staticmethod
    def generate_url_for_id(
            id_type: IdType,
            media_type: MediaType,
            _id: str
    ) -> str:
        """
        Generates a URL for an ID
        ...
        anime_manga = "anime"
        if media_type in IdHelper.literature_media_types():
            anime_manga = "manga"
    ...
    @staticmethod
    def literature_media_types() -> List[MediaType]:
        """
        :return: A list of literature media types
        """
        return [
            MediaType.BOOK,
    ...
    @staticmethod
    def int_id_types() -> List[IdType]:
        """
        :return: A list of ID types that are required to be integers
        """
        return [
            IdType.MYANIMELIST,
            IdType.ANILIST,
    ...
    @staticmethod
    def theme_song_id_types() -> List[IdType]:
        """
        :return: A list of ID types that can apply to theme songs
        """
        return [
            IdType.TVDB,
            IdType.MYANIMELIST,
