...
class MangaVolume(object):
    ...
    def get_volume_name(self) -> str:
        """
        Generates a Volume name for this volume based on the volume number, or returns
        the volume name previously set by the set_volume_name method.

        :return: the volume name as a string
        """
        return self.volume_name if self.volume_name != "" else "Volume " + str(self.volume_number).zfill(2)
