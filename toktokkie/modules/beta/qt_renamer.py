...
class Ui_Renamer(object):
    def setupUi(self, Renamer):
        ...
        self.changelist = QtWidgets.QListWidget(self.centralwidget)
        self.changelist.setSelectionMode(QtWidgets.QAbstractItemView.MultiSelection)
        self.changelist.setSelectionBehavior(QtWidgets.QAbstractItemView.SelectRows)
        self.changelist.setObjectName("changelist")
        self.gridLayout.addWidget(self.changelist, 1, 0, 1, 5)
