...
class TestBase(TestCase):
    ...
    and unit test for the Base metadata class
    """
    ...
    def generate_metadata(self, user_input: List[str] = None) -> Base:
        ...
        If no user input is provided, the json data example will be used
        ...
        if user_input is not None:
            ...
            return self.metadata_cls(self.json_data_example)
    ...
    def test_generating_metadata_with_existing_metadata_from_user_input(self):
        """
        Tests generating metadata from user input if the metadata directory
        ...
        self.assertEqual(new.to_json(), metadata.to_json())
