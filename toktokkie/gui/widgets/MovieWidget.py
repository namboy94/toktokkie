...
class MovieWidget(QWidget, Ui_MovieWidget):
    """
    Class that defines the behaviour of a Movie widget
    """
    ...
    def set_metadata(self, metadata: Movie):
        """
    ...
    def set_icon_image(self):
        """
        Sets the icon image of a Movie Widget
        :return: None
        """
