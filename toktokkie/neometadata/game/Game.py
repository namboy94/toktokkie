...
from toktokkie.neometadata.game.GamePrompter import GamePrompter
from toktokkie.neometadata.game.GameRenamer import GameRenamer
from toktokkie.neometadata.game.GameValidator import GameValidator
