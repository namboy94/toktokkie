...
class Ui_TvSeriesConfig(object):
    def setupUi(self, TvSeriesConfig):
        ...
        TvSeriesConfig.resize(1044, 579)
        ...
        TvSeriesConfig.setTabOrder(self.tvdb_url_edit, self.pushButton)
        TvSeriesConfig.setTabOrder(self.pushButton, self.resolution_one_edit_x)
    ...
    def retranslateUi(self, TvSeriesConfig):
        ...
        self.pushButton.setText(_translate("TvSeriesConfig", "Go"))
