...
class UnitTests(unittest.TestCase):
    ...
    def test_loading_json_file(self):
        self.tui.json_file_location.set_edit_text(os.path.join("json_test", "updater.json"))
    ...
    def test_loading_invalid_json_file(self):
        self.tui.json_file_location.set_edit_text(os.path.join("json_test", "invalid-updater.json"))
        self.tui.load_json_file(None)
    ...
    def test_loading_non_existant_file(self):
        self.tui.json_file_location.set_edit_text(os.path.join("json_test", "thisfiledoesnotexist.json"))
        self.tui.load_json_file(None)
    ...
    def test_adding_series(self):
        ...
        self.assertEqual(self.tui.search_name_edit.get_edit_text(), "New Series")
        self.tui.search_name_edit.set_edit_text("BlaBla")
        self.assertNotEqual(self.tui.search_name_edit.get_edit_text(), "New Series")
    ...
    def test_saving_unedited_json_file(self):
        ...
        handler = JsonHandler(os.path.join("json_test", "updater.json"))

        self.assertTrue(handler.get_series()[0].equals(self.tui.json_handler.get_series()[0]))
        self.assertTrue(handler.get_series()[1].equals(self.tui.json_handler.get_series()[1]))
        self.assertEqual(len(handler.get_series()), len(self.tui.json_handler.get_series()))
    ...
    def test_saving_newly_generated_config(self):
        self.tui.json_file_location.set_edit_text(os.path.join("json_test", "generated.json"))
        self.tui.generate_new_series(None)
        self.tui.generate_new_series(None)
        self.tui.generate_new_series(None)
        self.tui.save_json_file(None)

        self.assertTrue(os.path.isfile(os.path.join("json_test", "generated.json")))
        self.assertEqual(len(JsonHandler(os.path.join("json_test", "generated.json")).get_series()), 3)
    ...
    def test_saving_to_empty_string_file_path(self):
        ...
        self.assertFalse(os.path.isfile(os.path.join("json_test", "generated.json")))
        self.assertEqual(len(self.tui.list_walker), 3)

    def test_saving_to_directory(self):
        self.tui.json_file_location.set_edit_text("json_test")
        self.tui.generate_new_series(None)
        self.tui.save_json_file(None)

        self.assertFalse(os.path.isfile("json_test"))
        self.assertTrue(os.path.isdir("json_test"))
        self.assertEqual(len(self.tui.list_walker), 3)

    def test_modifying_information(self):
        self.tui.generate_new_series(None)
        self.tui.search_name_edit.set_edit_text("Modified")
        self.tui.bot_edit.set_edit_text("TheBot")
        self.tui.confirm_series_information(None)

        self.assertEqual(self.tui.json_handler.get_series()[0].get_search_name(), "Modified")
        self.assertEqual(self.tui.json_handler.get_series()[0].get_bot_preference(), "TheBot")
