...
class TVSeriesManagerUnitTests(unittest.TestCase):
    ...
    def test_tv_series_directory_check(self):
        ...
        self.assertFalse(TVSeriesManager.is_tv_series_directory(os.path.join(test_dir, "Random Folder")))
    ...
    def test_recursive_tv_series_checker(self):
        ...
        self.assertTrue(os.path.join(test_dir, "Random Folder") not in directories)
