...
try:
    ...
    from tok_tokkie.plugins.renamer.RenamerPlugin import RenamerPlugin
    from tok_tokkie.plugins.iconizer.IconizerPlugin import IconizerPlugin
    from tok_tokkie.plugins.batchdownloadmanager.BatchDownloadManagerPlugin import BatchDownloadManagerPlugin
    from tok_tokkie.plugins.showmanager.ShowManagerPlugin import ShowManagerPlugin
