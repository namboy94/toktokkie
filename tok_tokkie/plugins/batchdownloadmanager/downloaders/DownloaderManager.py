...
try:
    ...
    from tok_tokkie.plugins.batchdownloadmanager.downloaders.HexChatPluginDownloader import HexChatPluginDownloader
    from tok_tokkie.plugins.batchdownloadmanager.downloaders.GenericDownloader import GenericDownloader
    from tok_tokkie.plugins.batchdownloadmanager.downloaders.IrcLibDownloader import IrcLibDownloader
