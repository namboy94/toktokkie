...
try:
    ...
    from tok_tokkie.plugins.common.onlinedatagetters.TVDBGetter import TVDBGetter
    from tok_tokkie.plugins.batchdownloadmanager.utils.ProgressStruct import ProgressStruct
    from tok_tokkie.plugins.batchdownloadmanager.searchengines.objects.XDCCPack import XDCCPack
    from tok_tokkie.plugins.batchdownloadmanager.downloaders.GenericDownloader import GenericDownloader
    from tok_tokkie.plugins.batchdownloadmanager.downloaders.implementations.IrcLibImplementation \
