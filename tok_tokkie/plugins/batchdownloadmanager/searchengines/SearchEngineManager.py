...
try:
    ...
    from tok_tokkie.plugins.batchdownloadmanager.searchengines.GenericGetter import GenericGetter
    from tok_tokkie.plugins.batchdownloadmanager.searchengines.NIBLGetter import NIBLGetter
    from tok_tokkie.plugins.batchdownloadmanager.searchengines.IntelGetter import IntelGetter
    from tok_tokkie.plugins.batchdownloadmanager.searchengines.IxIRCGetter import IxIRCGetter
