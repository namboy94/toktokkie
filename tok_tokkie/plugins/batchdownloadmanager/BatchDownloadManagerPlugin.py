...
try:
    ...
    from tok_tokkie.plugins.batchdownloadmanager.userinterfaces.BatchDownloadManagerGui \
        import BatchDownloadManagerGui
    from tok_tokkie.plugins.batchdownloadmanager.userinterfaces.BatchDownloadManagerCli import \
