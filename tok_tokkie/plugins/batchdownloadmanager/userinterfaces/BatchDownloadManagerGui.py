...
try:
    ...
    from tok_tokkie.plugins.batchdownloadmanager.searchengines.SearchEngineManager import SearchEngineManager
    from tok_tokkie.plugins.batchdownloadmanager.utils.BatchDownloadManager import BatchDownloadManager
    from tok_tokkie.plugins.batchdownloadmanager.downloaders.DownloaderManager import DownloaderManager
    from tok_tokkie.plugins.batchdownloadmanager.utils.ProgressStruct import ProgressStruct
    from tok_tokkie.plugins.iconizer.utils.DeepIconizer import DeepIconizer
