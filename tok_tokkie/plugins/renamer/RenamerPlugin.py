...
try:
    ...
    from tok_tokkie.plugins.renamer.userinterfaces.RenamerGui import RenamerGui
    from tok_tokkie.plugins.renamer.userinterfaces.RenamerCli import RenamerCli
