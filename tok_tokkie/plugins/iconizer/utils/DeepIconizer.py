...
try:
    ...
    from plugins.iconizer.utils.iconizers.WindowsIconizer import WindowsIconizer
except ImportError:
    from tok_tokkie.plugins.iconizer.utils.iconizers.NautilusNemoIconizer import NautilusNemoIconizer
    from tok_tokkie.plugins.iconizer.utils.iconizers.WindowsIconizer import WindowsIconizer
