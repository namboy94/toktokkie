...
try:
    ...
    from tok_tokkie.plugins.iconizer.userinterfaces.IconizerGui import IconizerGui
    from tok_tokkie.plugins.iconizer.userinterfaces.IconizerCli import IconizerCli
