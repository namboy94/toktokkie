...
class TwistedDownloader(object):
    ...
    def __init__(self, packs, progress_dict, show_name="", episode_number=0, season_number=0):
        """
        Constructor
        :param packs: the packs to be downloaded
        :param progress_dict: The dictionary that shows the progress of the downloads
